	...
	.then((data) => {
		...
		$(".appended").empty()
			...
			.then(data => {
				...
				$fgm.append(`<span class="appended">Field Goals Made:<br></span>`)
				$fga.append(`<span class="appended">Field Goals Attempted:<br></span>`)
				$fgp.append(`<span class="appended">Field Goal Percentage:<br></span>`)
